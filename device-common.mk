...
ifeq (,$(filter exthm_marlin exthm_sailfish, $(TARGET_PRODUCT)))
PRODUCT_PACKAGES += \
    nanotool \
    sensortest
endif
...
ifneq ($(filter exthm_sailfish% aosp_sailfish% sailfish% exthm_marlin% aosp_marlin% marlin%, $(TARGET_PRODUCT)),)
PRODUCT_PROPERTY_OVERRIDES += \
